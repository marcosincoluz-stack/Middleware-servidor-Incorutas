...
router.get('/metrics', verifyApiToken, asyncHandler(async (req, res) => {
  ...
  const prometheusText = [
    ...
    '',
    '# HELP photo_sync_planos_total Total number of planos uploaded to Supabase',
    '# TYPE photo_sync_planos_total counter',
    `photo_sync_planos_total ${status.totalPlanos}`,
    '',
    '# HELP photo_sync_session_planos_total Total number of planos uploaded in the current session',
    '# TYPE photo_sync_session_planos_total counter',
    `photo_sync_session_planos_total ${status.sessionPlanos}`,
    '',
    '# HELP photo_sync_plano_polling_stalled_cycles Consecutive polling cycles with candidates but 0 enqueued (stalled)',
    '# TYPE photo_sync_plano_polling_stalled_cycles gauge',
    `photo_sync_plano_polling_stalled_cycles ${status.planoStalledCycles}`,
    '',
